...
> Lite monitor website uptime with alerts

[![PyPI version](https://badge.fury.io/py/lite-site-ping.svg)](https://pypi.org/project/lite-site-ping/)
...
```bash
pip install lite-site-ping
```

## Quick Start

```python
from lite_site_ping import ping

# Basic usage
result = ping("your input here")
print(result)
```
...
result = ping("Hello World")

# Example 2: Batch processing
from lite_site_ping import batch
